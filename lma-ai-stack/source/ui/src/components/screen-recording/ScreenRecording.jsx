...
const ScreenRecording = () => {
  const { currentCredentials, setErrorMessage } = useAppContext();
    ...
    <div className="screen-recording">
      <Container
        header={
          <Header
            variant="h2"
            description="Record your screen alongside audio for comprehensive meeting analysis"
          >
            Screen Recording
          </Header>
        }
      >
        <SpaceBetween size="l">
          <Alert
            type="info"
            header="Screen Recording Feature"
          >
            This feature allows you to record your screen alongside audio, enabling the meeting assistant to analyze both visual content and spoken words for more comprehensive meeting summaries.
          </Alert>
          ...
          >
            <SpaceBetween size="l">
              <FormField
                label="Meeting Topic"
                description="Enter a descriptive name for your meeting"
              >
                <Input
                  value={meetingTopic}
              ...
              <FormField
                label="Your Name"
                description="Name to associate with your audio"
              >
                <Input
                  value={agentName}
              ...
              <FormField
                ...
                description="Names of other meeting participants (optional)"
              >
                <Input
              ...
              {recording && (
                <Box>
                  <SpaceBetween direction="horizontal" size="s">
                    <StatusIndicator
                      type={isFlashing ? 'pending' : 'success'}
                    >
                      Recording
                    </StatusIndicator>
                    <TextContent>
              ...
              {recordingStatus === 'processing' && (
                <Alert type="info">
                  Processing your screen recording and generating analysis...
                </Alert>
              )}
      ...
      >
        <SpaceBetween size="l">
          <TextContent>
            <p>
              <strong>Important:</strong> You are responsible for complying with legal, corporate, and ethical restrictions that apply to recording meetings and calls.
            </p>
            <p>
              This feature will record your screen content and audio. Do not use this solution to record calls if otherwise prohibited.
            </p>
            <p>
              The recording will be processed to generate meeting summaries and insights.
            </p>
          </TextContent>
